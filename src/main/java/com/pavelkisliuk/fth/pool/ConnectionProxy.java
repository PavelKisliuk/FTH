...
class ConnectionProxy implements Connection {
	...
	void closeProxy() throws ConnectionPoolException {
		try {
			...
			throw new ConnectionPoolException("SQLException in ConnectionProxy -> closeProxy()");
		}
	}
	...
	void abortProxy(Executor executor) throws ConnectionPoolException {
		try {
			...
			throw new ConnectionPoolException("SQLException in ConnectionProxy -> abortProxy(Executor executor)");
		}
	}
